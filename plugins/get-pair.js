...
cmd({
    ...
    try {
        ...
        const response = await axios.get(`https://sessionscannert-1-m5sp.onender.com/code?number=${encodeURIComponent(phoneNumber)}`);
...
cmd({
    ...
    try {
        ...
        const response = await axios.get(`https://sessionscannert-1-m5sp.orender.com/code?number=${encodeURIComponent(phoneNumber)}`);
